...
export const Sidebar = ({ sidebarOpen, setSidebarOpen }: Props) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-in-out dark:bg-boxDark lg:static lg:translate-x-0 ${
